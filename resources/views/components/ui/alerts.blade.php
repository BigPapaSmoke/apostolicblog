...
<div x-data="{open: true}" x-init="setTimeout(() => {open = false }, 3000)"
    ...
    x-transition:leave="transition durantion-500 transform ease-in" x-transition:leave-end="opacity-0" class="flex items-center p-2 mb-4 text-white bg-red-400 rounded">
